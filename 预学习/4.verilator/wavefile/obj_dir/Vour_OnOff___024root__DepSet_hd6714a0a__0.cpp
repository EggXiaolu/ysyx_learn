...
#endif
                VL_FATAL_MT("our_OnOff.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("our_OnOff.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("our_OnOff.v", 1, "", "NBA region did not converge.");
            }
