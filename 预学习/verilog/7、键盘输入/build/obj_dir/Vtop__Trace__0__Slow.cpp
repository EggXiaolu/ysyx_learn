...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+27,"clrn", false,-1);
    tracep->declBit(c+28,"ps2_clk", false,-1);
    tracep->declBit(c+29,"ps2_data", false,-1);
    tracep->declBus(c+30,"seg0", false,-1, 7,0);
    tracep->declBus(c+31,"seg1", false,-1, 7,0);
    tracep->declBus(c+32,"seg2", false,-1, 7,0);
    tracep->declBus(c+33,"seg3", false,-1, 7,0);
    tracep->declBus(c+34,"seg4", false,-1, 7,0);
    tracep->declBus(c+35,"seg5", false,-1, 7,0);
    ...
    tracep->declBus(c+34,"seg4", false,-1, 7,0);
    tracep->declBus(c+35,"seg5", false,-1, 7,0);
    tracep->declBit(c+40,"nextdata_n", false,-1);
    tracep->declBit(c+1,"ready", false,-1);
    tracep->declBit(c+2,"overflow", false,-1);
    tracep->declBus(c+36,"data", false,-1, 7,0);
    tracep->declBus(c+3,"tmp_data", false,-1, 7,0);
    tracep->declBus(c+4,"out_data", false,-1, 7,0);
    tracep->declBus(c+5,"key_count", false,-1, 7,0);
    tracep->declBus(c+22,"ascii", false,-1, 7,0);
    tracep->declBus(c+41,"a", false,-1, 3,0);
    tracep->declBus(c+42,"b", false,-1, 3,0);
    tracep->declBus(c+43,"c", false,-1, 3,0);
    tracep->declBus(c+44,"d", false,-1, 3,0);
    ...
    tracep->declBus(c+22,"y", false,-1, 7,0);
    tracep->declBus(c+22,"tmp", false,-1, 7,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+21,((0xfU & ((IData)(vlSelf->top__DOT__key_count) 
                                      >> 4U))),4);
    bufp->fullCData(oldp+22,(vlSelf->top__DOT__my_ps2_to_ascii__DOT__tmp),8);
    bufp->fullCData(oldp+23,(vlSelf->top__DOT__next_state),4);
    bufp->fullCData(oldp+24,((0xfU & (IData)(vlSelf->top__DOT__my_ps2_to_ascii__DOT__tmp))),4);
    bufp->fullCData(oldp+25,((0xfU & ((IData)(vlSelf->top__DOT__my_ps2_to_ascii__DOT__tmp) 
                                      >> 4U))),4);
    bufp->fullBit(oldp+26,(vlSelf->clk));
    bufp->fullBit(oldp+27,(vlSelf->clrn));
    bufp->fullBit(oldp+28,(vlSelf->ps2_clk));
    bufp->fullBit(oldp+29,(vlSelf->ps2_data));
    bufp->fullCData(oldp+30,(vlSelf->seg0),8);
    bufp->fullCData(oldp+31,(vlSelf->seg1),8);
    bufp->fullCData(oldp+32,(vlSelf->seg2),8);
    bufp->fullCData(oldp+33,(vlSelf->seg3),8);
    bufp->fullCData(oldp+34,(vlSelf->seg4),8);
    bufp->fullCData(oldp+35,(vlSelf->seg5),8);
    bufp->fullCData(oldp+36,(((1U == (IData)(vlSelf->top__DOT__state))
                               ? (IData)(vlSelf->top__DOT__out_data)
                               : 0U)),8);
    bufp->fullCData(oldp+37,(vlSelf->top__DOT__state),4);
    bufp->fullCData(oldp+38,(((1U == (IData)(vlSelf->top__DOT__state))
                               ? (0xfU & (IData)(vlSelf->top__DOT__out_data))
                               : 0U)),4);
    bufp->fullCData(oldp+39,(((1U == (IData)(vlSelf->top__DOT__state))
                               ? (0xfU & ((IData)(vlSelf->top__DOT__out_data) 
                                          >> 4U)) : 0U)),4);
    bufp->fullBit(oldp+40,(vlSelf->top__DOT__nextdata_n));
    bufp->fullCData(oldp+41,(0U),4);
    bufp->fullCData(oldp+42,(1U),4);
    bufp->fullCData(oldp+43,(2U),4);
    bufp->fullCData(oldp+44,(4U),4);
}
